...
for ( var i=0 ; i < data.length; i++){
  ...
  titulo.innerHTML += `<img src="https://png.pngtree.com/element_pic/16/11/19/3bcc8db55bdecafcd59753753a4f0aa9.jpg" alt="Favoritos" width="15" height="15"><a href="${data[i].url}" target="_blank">${data[i].nome}<font color="green">- pasterbin.com</font> - [PASTERBIN] <font color="black">adicionado em ${dateAdd}</font></a>` ;
